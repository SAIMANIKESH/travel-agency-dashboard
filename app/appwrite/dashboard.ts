...
export const getUsersAndTripsStats = async (): Promise<DashboardStats> => {
  ...
  return {
    ...
    userRole: {
      ...
      currentMonth: filterByDate(filterUsersByRole('users'), "joinedAt", startCurrent, undefined),
      lastMonth: filterByDate(filterUsersByRole('users'), "joinedAt", startPrev, endPrev),
    },
